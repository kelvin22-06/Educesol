  ...
  return (
    <div className="contact-container">
      <div className="contact-map">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.053894459461!2d144.96305761569213!3d-37.81362797975193!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0x5045675218d6a36!2sMelbourne%20VIC%2C%20Australia!5e0!3m2!1sen!2sus!4v1678888888888!5m2!1sen!2sus"
          width="100%"
          height="320"
          style={{ border: 0 }}
          allowFullScreen
        ...
        <div className="contact-details-section">
          ...
          <div className="contact-details">
            <div className="contact-item">
              ...
              <a href="http://www.yoursite.com" className="contact-link">www.yoursite.com</a>
            </div>
            <div className="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" className="contact-icon" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@yoursite.com" className="contact-link">info@yoursite.com</a>
            </div>
            <div className="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" className="contact-icon" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="contact-item">
              ...
              <span>INC 22 Elizabeth Str.<br/>Melbourne, Victoria 8777.</span>
            </div>
          </div>
        </div>
      </div>
